...
$label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'deon' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'deon' );
...
<div class="qodef-quantity-buttons quantity">
	...
	<input
		type="<?php echo esc_attr( apply_filters( 'deon_filter_woo_quantity_input_type', 'text' ) ); ?>"
		...
		title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'deon' ); ?>"
		size="4"
