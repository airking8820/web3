					...
					$this.magnificPopup(
						{
							...
							gallery: {
								enabled: true,
								arrowMarkup: '<button title="%title%" type="button" class="mfp-arrow mfp-arrow-%dir%"><span class="qodef-icon-linea-icons icon-arrows-right"></span></button>', // markup of an arrow button
							},
							index: index,
							type: 'image',
							image: {
